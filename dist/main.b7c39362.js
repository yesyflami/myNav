...
var render = function render() {
  ...
  hashMap.forEach(function (node, index) {
    console.log(index); // onclick="window.open('${node.url}','_self')"
...
window.onbeforeunload = function () {
  ...
  var string = JSON.stringify(hashMap); //对象=>字符串
...
//# sourceMappingURL=main.b7c39362.js.map